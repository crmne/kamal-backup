...
class CLITest < Minitest::Test
  ...
  def test_init_creates_local_config_stubs
    Dir.mktmpdir do |dir|
      ...
      assert_includes File.read(File.join(dir, "config", "kamal-backup.yml")), "secret: RESTIC_PASSWORD"
      ...
      assert_includes out, "- RESTIC_PASSWORD"
      refute_includes out, "/etc/kamal-backup/your-app/restic-password"
      assert_includes out, "kamal-backup passes RESTIC_PASSWORD to restic through a private temporary password file."
